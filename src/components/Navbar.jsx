...
function Navbar() {
  ...
  return (
    <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
      ...
      {/*Mobile Menu*/}
      {nav ?<div className=' bg-black/80 w-full fixed h-screen z-10  top-0 left-0'>

</div> :''}
      
      {/*Side draver menu */}
      <div className={nav ? 'fixed top-0 left-0 w-[300px] h-screen bg-white  z-10 duration-350' :'fixed top-0 left-[-100%] w-[300px] h-screen bg-white  z-10 duration-300'}>
